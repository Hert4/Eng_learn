...
const AIModal = ({ currentUser }) => {
    ...
    //URL GRD
    const URL_AI = "https://be18c73336352c340c.gradio.live";
                ...
                >
                    ...
                    >
                        <Flex alignItems="center" gap={3}>
                            ...
                            />
                            <Box>
                                <Heading size="md" fontWeight="600">Chim AI</Heading>
                                ...
                                >
                                    <Flex align="center" gap={2} mb={3}>
                                        <Box
                                            ...
                                            bg="linear-gradient(135deg, #007AFF 0%, #34C759 100%)"
                                        />
                                        <Box fontSize="sm" fontWeight="600" color="#007AFF">Chim AI</Box>
                                    </Flex>
