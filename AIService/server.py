...
# Import Spark-TTS (đảm bảo thư mục Spark-TTS đã được tải về local)
sys.path.append("Spark-TTS")  # Cập nhật đường dẫn tương đối đến thư mục Spark-TTS
...
try:
    ...
    qwen_tokenizer = AutoTokenizer.from_pretrained("Qwen2.5-0.5B-Instruct")
